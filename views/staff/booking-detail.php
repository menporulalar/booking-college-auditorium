    ...
    <div class="card">
      ...
      <div class="card-body" style="display:flex;flex-direction:column;gap:10px;">
        ...
        <?php if ($booking['status'] === 'approved'): ?>
          ...
          <?php
          require_once __DIR__ . '/../../app/Helpers/ICalExport.php';
          $googleUrl = ICalExport::googleCalendarUrl($booking);
          ?>
          <a href="<?= htmlspecialchars($googleUrl) ?>" target="_blank" rel="noopener" class="btn btn-secondary" style="width:100%;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Add to Google Calendar
          </a>

          <?php if ($booking['recurrence_group_id']): ?>
          <a href="<?= APP_URL ?>/bookings/series/<?= $booking['recurrence_group_id'] ?>/ical" class="btn btn-secondary" style="width:100%;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 11-2.64-6.36L21 8"/><path d="M21 3v5h-5"/></svg>
            Download Entire Series (.ics)
          </a>
          <?php endif; ?>
        <?php endif; ?>

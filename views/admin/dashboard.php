...
$pendingCount  = Booking::pendingCount();
  ...
  <div class="stat-card">
    ...
    <div class="stat-sub">
      <?php if ($conflictCount > 0): ?>
        <span style="color:var(--red);font-weight:600;"><?= $conflictCount ?> with conflicts</span>
      <?php else: ?>
        <a href="<?= APP_URL ?>/admin/bookings/pending" style="color:var(--blue);">Review now →</a>
      <?php endif; ?>
    </div>
  </div>
  <div class="stat-card">
    <div class="stat-label">Today's Bookings</div>
    <div class="stat-value" style="color:var(--blue);"><?= $todayCount ?></div>
    <div class="stat-sub">Approved &amp; scheduled today</div>
  </div>
  <div class="stat-card">
